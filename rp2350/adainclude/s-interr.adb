...
pragma Warnings (Off);  -- XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
package body System.Interrupts is
   ...
   begin
      for H of Handlers loop
         raise Program_Error with "handlers not implemented";
         --  Install_One_Handler :
         --  declare
   ...
   begin
      ...
      --     Interrupt_Handlers (ID).Wrapper
      --       (Interrupt_Handlers (ID).Parameter);
      --  end;
   end IRQ_Handler;
