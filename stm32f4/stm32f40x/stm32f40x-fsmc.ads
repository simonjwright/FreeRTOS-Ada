...
package STM32F40x.FSMC is
   ...
   subtype BCR1_MWID_Field is STM32F40x.UInt2;
   subtype BCR1_FACCEN_Field is STM32F40x.Bit;
   subtype BCR1_BURSTEN_Field is STM32F40x.Bit;
   subtype BCR1_WAITPOL_Field is STM32F40x.Bit;
   subtype BCR1_WAITCFG_Field is STM32F40x.Bit;
   subtype BCR1_WREN_Field is STM32F40x.Bit;
   subtype BCR1_WAITEN_Field is STM32F40x.Bit;
   subtype BCR1_EXTMOD_Field is STM32F40x.Bit;
   subtype BCR1_ASYNCWAIT_Field is STM32F40x.Bit;
   subtype BCR1_CBURSTRW_Field is STM32F40x.Bit;
   ...
   subtype PIO4_IOHIZx_Field is STM32F40x.Byte;
