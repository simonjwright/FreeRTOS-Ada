...
package Registers.Cortex.NVIC with Preelaborate is
   ...
   with Convention => Ada, Volatile, Size => 8 * (16#04EC# + 4);

   for NVIC_T use record
      ISER at 16#0000# range 0 .. 255;
      ICER at 16#0180# range 0 .. 255;
      ISPR at 16#0200# range 0 .. 255;
      ICPR at 16#0280# range 0 .. 255;
      IABR at 16#0300# range 0 .. 255;
      IPRO at 16#0400# range 0 .. 1919;
   end record;
