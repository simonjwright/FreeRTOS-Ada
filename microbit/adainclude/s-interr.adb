...
package body System.Interrupts is
   ...
   procedure Install_Restricted_Handlers
     (Prio     : Any_Priority;
      ...
      --  Note, because the NVIC is configured to have 2 priority bits
      --  and no subpriority bits, the actual interrupt priority is to
      --  be held in the top 2 bits of NVIC.IPR (n).
      --
      --  The lowest interrupt priority is 3, the highest permissible
      --  one to avoid trampling on FreeRTOS is 2 (see
      --  FreeRTOSConfig.h).
   begin
