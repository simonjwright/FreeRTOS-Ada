...
package STM32F429x.DBG is
   ...
   subtype DBGMCU_CR_TRACE_IOEN_Field is STM32F429x.Bit;
   subtype DBGMCU_CR_TRACE_MODE_Field is STM32F429x.UInt2;
   ...
   subtype DBGMCU_APB1_FZ_DBG_TIM5_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM6_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM7_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM12_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM13_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM14_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_WWDG_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_IWDEG_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_J2C1_SMBUS_TIMEOUT_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_J2C2_SMBUS_TIMEOUT_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_J2C3SMBUS_TIMEOUT_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_CAN1_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB1_FZ_DBG_CAN2_STOP_Field is STM32F429x.Bit;
   ...
   subtype DBGMCU_APB2_FZ_DBG_TIM10_STOP_Field is STM32F429x.Bit;
   subtype DBGMCU_APB2_FZ_DBG_TIM11_STOP_Field is STM32F429x.Bit;
   ...
   type DBGMCU_APB2_FZ_Register is record
      ...
      --  unspecified
      Reserved_2_15  : STM32F429x.UInt14 := 16#0#;
