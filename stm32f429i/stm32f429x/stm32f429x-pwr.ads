...
package STM32F429x.PWR is
   ...
   subtype CR_CSBF_Field is STM32F429x.Bit;
   subtype CR_PVDE_Field is STM32F429x.Bit;
   ...
   subtype CSR_BRR_Field is STM32F429x.Bit;
   ...
   type CSR_Register is record
      ...
      --  unspecified
      Reserved_10_13 : STM32F429x.UInt4 := 16#0#;
