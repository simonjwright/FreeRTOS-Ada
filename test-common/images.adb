...
package body Images is
   ...
   task Long_Integers with Storage_Size => 1024;
   ...
   task Long_Long_Integers with Storage_Size => 1024;
   ...
   task Unsigned_32s with Storage_Size => 1024;
   ...
   task Unsigned_64s with Storage_Size => 1024;
   ...
   task Enumerations with Storage_Size => 1024;
